...
func runMigrations(db *sql.DB) error {
	_, err := db.Exec(`
		...
		CREATE TABLE IF NOT EXISTS rooms (
			...
			user_currently_playing TEXT DEFAULT NULL,
		...
		CREATE INDEX IF NOT EXISTS idx_room_moves_room_uuid ON room_moves (room_uuid);
		CREATE INDEX IF NOT EXISTS idx_room_moves_user_uuid ON room_moves (user_uuid);
		CREATE UNIQUE INDEX IF NOT EXISTS idx_room_moves_room_uuid_user_uuid_x_y ON room_moves (room_uuid, user_uuid, x, y);

		CREATE TABLE IF NOT EXISTS room_user (
			room_uuid TEXT NOT NULL,
			user_uuid TEXT NOT NULL,
		    ships_schema TEXT DEFAULT "",
